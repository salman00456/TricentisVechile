...
public class SendQuotePagePOM extends Base{
	...
	@FindBy(xpath =ObjectRepository.emailTxt) WebElement emailTxt;
	@CacheLookup
	@FindBy(xpath =ObjectRepository.phoneTxt) WebElement phoneTxt;
	@CacheLookup
	@FindBy(xpath =ObjectRepository.ussernameTxt ) WebElement ussernameTxt;
	@CacheLookup
	@FindBy(xpath =ObjectRepository.passwordTxt ) WebElement passwordTxt;
	@CacheLookup
	@FindBy(xpath =ObjectRepository.confrmPassTxt ) WebElement confrmPassTxt;
	@CacheLookup
	@FindBy(xpath =ObjectRepository.commentTxt ) WebElement commentTxt;
	...
	public void enterPhone(String phoneValue) {
		phoneTxt.sendKeys(phoneValue);
	}
	
	public void enterUsername(String userValue) {
		ussernameTxt.sendKeys(userValue);
	}
	
	public void enterPassword(String passValue) {
		passwordTxt.sendKeys(passValue);
	}
	
	public void enterConfirmPass(String confpassValue) {
		confrmPassTxt.sendKeys(confpassValue);
	}
	
	public void enterComment(String commentValue) {
		commentTxt.sendKeys(commentValue);
	}
